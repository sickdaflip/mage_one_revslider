				...
				if (response.success) {
					...
					setTimeout(function() {
						RVS.F.RSDialog.create({
							...
							subtext:/*RVS_LANG.visit_page+': <a class="blankpagelink" href="'+response.open+'" target="blank">'+response.open+'</a><br>'+*/(response.edit!==undefined && response.edit.length>0 ? RVS_LANG.edit_page+': <a class="blankpagelink" href="'+response.edit+'" target="blank">'+response.edit+'</a>' : ''),
							do:{
								icon:"exit_to_app",
		...
		*/
		 ...
		 */
		 ...
		 RVS.DOC.on('click','.embedslider',function() {
			...
			txt += "<input class='inputtocopy' id='embed_shortcode_a' readonly value='{{block type=\"nwdrevslider/revslider\" alias=\""+slide.alias+"\"}}'/>";
			...
			txt += '<div class="inputrow">';
			txt += "<input class='inputtocopy' id='embed_shortcode_modal' readonly value='{{block type=\"nwdrevslider/revslider\" usage=\"modal\" alias=\""+slide.alias+"\"}}'/>";
			...
			txt += '<div class="inputrow">';
			txt += "<input class='inputtocopy' readonly id='embed_shortcode_b' value='<block type=\"nwdrevslider/revslider\" name=\"revslider\"><action method=\"setAlias\"><alias>"+slide.alias+"</alias></action></block>'>";
			...
			txt += '<div class="inputrow">';
			txt += '<input class="inputtocopy" readonly id="embed_shortcode_c" value="$this->getLayout()->createBlock(\'nwdrevslider/revslider\')->setAlias(\''+slide.alias+'\')->toHtml();">';
...
/*
TODO: Do we need to grayscale Magento menu as well?
