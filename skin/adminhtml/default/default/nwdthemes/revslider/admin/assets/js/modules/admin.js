...
*********************************************************/
	...
	*/
	...
	RVS.F.openPreivew = function(_) {
		...
		document.getElementById('copy_shortcode_from_preview').value = '{{block type="nwdrevslider/revslider" alias="'+_.alias+'"}}';
    ...
    RVS.F.extendObject = function(obj1, obj2) {
        return RVS.F.cleanExtendedObjet(jQuery.extend(true, {}, obj1, obj2), obj1, obj2);
    };
