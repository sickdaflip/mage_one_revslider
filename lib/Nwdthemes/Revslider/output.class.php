...
class RevSliderOutput extends RevSliderFunctions {
	...
	public function set_slider_id($sid){
		$this->slider_id = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_slider_id', $sid, $this);
	}
	...
	public function set_add_to($add_to) {
		$this->add_to = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_add_to', $add_to, $this);
	}
	...
	public function get_add_to(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_add_to', trim(strtolower($this->add_to)), $this);
	}
	...
	public function set_slider($slider){
		$this->slider = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_slider', $slider, $this);
	}
	...
	public function get_slider(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_slider', $this->slider, $this);
	}
	...
	public function get_slider_id(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_slider_id', $this->slider_id, $this);
	}
	...
	public function set_html_id($html_id){
		$this->html_id = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_html_id', $html_id, $this);
	}
	...
	public function set_slide_id($slide_id){
		$this->slide_id = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_slide_id', $slide_id, $this);
	}
	...
	public function get_slide_id(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_slide_id', $this->slide_id, $this);
	}
	...
	public function set_layers($layers){
		$this->layers = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_layers', $layers, $this);
	}
	...
	public function get_layers(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_layers', $this->layers, $this);
	}
	...
	public function set_layer($layer){
		$this->layer = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_layer', $layer, $this);
	}
	...
	public function get_layer(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_layer', $this->layer, $this);
	}
	...
	public function get_html_id(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_html_id', $this->html_id, $this);
	}
	...
	public function set_static_slide($slide){
		$this->static_slide = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_static_slide', $slide, $this);
	}
	...
	public function get_static_slide(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_static_slide', $this->static_slide, $this);
	}
	...
	public function get_do_static(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_do_static_layers', $this->do_static, $this);
	}
	...
	public function set_custom_settings($settings){
		...
		$this->custom_settings = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_custom_settings', $settings, $this);
	}
	...
	public function get_custom_settings(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_custom_settings', $this->custom_settings, $this);
	}
	...
	public function set_layer_unique_id(){
		...
		$this->uid = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_layer_unique_id', $uid, $layer, $this);
	}
	...
	public function get_layer_unique_id(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_layer_unique_id', $this->uid, $this);
	}
	...
	public function get_preview_mode(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_preview_mode', $this->preview_mode, $this);
	}
	...
	public function set_preview_mode($preview_mode){
		$this->preview_mode = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_preview_mode', $preview_mode, $this);
	}
	...
	public function set_markup_export($markup_export){
		$this->markup_export = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_markup_export', $markup_export, $this);
	}
	...
	public function get_markup_export(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_markup_export', $this->markup_export, $this);
	}
	...
	public function get_custom_order(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_custom_order', $this->custom_order, $this);
	}
	...
	public function get_language(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_language', $this->language, $this);
	}
	...
	public function change_language($language){
		$this->language = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_change_language', $language, $this);
	}
	...
	public function set_custom_order($order){
		...
		$this->custom_order = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_custom_settings', $order, $this);
	}
	...
	public function set_only_published($published){
		$this->only_published = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_published', $published, $this);
	}
	...
	public function get_only_published(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_published', $this->only_published);
	}
	...
	public function set_slides_num_index($index){
		$this->slides_num_index = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_slides_num_index', $index, $this);
	}
	...
	public function get_slides_num_index(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_slides_num_index', $this->slides_num_index, $this);
	}
	...
	public function set_gallery_ids($ids){
		$this->gallery_ids = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_gallery_ids', $ids, $this);
	}
	...
	public function get_gallery_ids(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_gallery_ids', $this->gallery_ids, $this);
	}
	...
	public function set_is_single_slide($single){
		$this->is_single_slide = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_is_single_slide', $single, $this);
	}
	...
	public function get_is_single_slide(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_is_single_slide', $this->is_single_slide, $this);
	}
	...
	public function set_slide($slide){
		$this->slide = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_set_slide', $slide, $this);
	}
	...
	public function get_slide(){
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_slide', $this->slide, $this);
	}
	...
	public function add_slider_to_stage($sid, $usage = ''){
		$this->usage = $usage;
		Mage::helper('nwdrevslider/framework')->do_action('revslider_add_slider_to_stage_pre', $sid, $this);
		...
		Mage::helper('nwdrevslider/framework')->do_action('revslider_add_slider_to_stage_post', $sid, $this);
	...
	public function add_slider_base(){
		try{
			Mage::helper('nwdrevslider/framework')->do_action('revslider_add_slider_base_pre', $this);

			Nwdthemes_Revslider_Helper_Framework::$rs_slider_serial++; //set the serial +1, so that if we have the slider two times, it has different ID's for sure
			 ...
			 **/
			if(version_compare($this->get_val($this->slider, array('settings', 'version')), Mage::helper('nwdrevslider/framework')->get_option('revslider_update_revision', '6.0.0'), '<')){
			...
			$this->slider = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_add_slider_base', $this->slider);

			//check if we are mobile and the slider needs to be printed or not
			if($this->slider->get_param(array('general', 'disableOnMobile'), false) === true && Mage::helper('nwdrevslider/framework')->wp_is_mobile()) return false;
			...
			$html_id = (trim($slider_id) !== '') ? $slider_id : 'rev_slider_'.$sid.'_'.Nwdthemes_Revslider_Helper_Framework::$rs_slider_serial;
			...
			Mage::helper('nwdrevslider/framework')->do_action('revslider_add_slider_base_post', $this);
		}catch(Exception $e){
	...
	public function get_slider_wrapper_div(){
		...
		$bg_color	= Mage::helper('nwdrevslider/framework')->esc_attr(trim($this->slider->get_param(array('layout', 'bg', 'color'))));
		...
		$style .= 'padding:'.Mage::helper('nwdrevslider/framework')->esc_attr($this->slider->get_param(array('layout', 'bg', 'padding'), '0')).';';
		...
		if($type != 'fullscreen'){
			...
			if($position != 'center'){
				...
				$style .= ($ma_l !== '') ? 'margin-left:'.Mage::helper('nwdrevslider/framework')->esc_attr($ma_l).';' : '';
				$style .= ($ma_r !== '') ? 'margin-right:'.Mage::helper('nwdrevslider/framework')->esc_attr($ma_r).';' : '';
			}
			...
			$style .= ($ma_t !== '') ? 'margin-top:'.Mage::helper('nwdrevslider/framework')->esc_attr($ma_t).';' : '';
			$style .= ($ma_b !== '') ? 'margin-bottom:'.Mage::helper('nwdrevslider/framework')->esc_attr($ma_b).';' : '';
		}

		//add background image (banner style)
		if($this->slider->get_param(array('layout', 'bg', 'useImage'), false) == true){
			$bg_img = Mage::helper('nwdrevslider/framework')->esc_attr($this->slider->get_param(array('layout', 'bg', 'image')));
			$bg_img = $this->check_valid_image($bg_img);
			if($bg_img !== false){
				$style .= 'background-image:url('.$bg_img.');';
				$style .= 'background-repeat:'.Mage::helper('nwdrevslider/framework')->esc_attr($this->slider->get_param(array('layout', 'bg', 'repeat'), 'no-repeat')).';'; //$this->slider->get_param(array('def', 'background', 'repeat'), 'no-repeat')
				$style .= 'background-size:'.Mage::helper('nwdrevslider/framework')->esc_attr($this->slider->get_param(array('layout', 'bg', 'fit'), 'cover')).';'; //$this->slider->get_param(array('def', 'background', 'fit'), 'cover')
				$style .= 'background-position:'.Mage::helper('nwdrevslider/framework')->esc_attr($this->slider->get_param(array('layout', 'bg', 'position'), 'center center')).';'; //$this->slider->get_param(array('def', 'background', 'position'), 'center center')
			}
		}
		...
		$r = RS_T3.'<!-- START '.Mage::helper('nwdrevslider/framework')->esc_html(str_replace('-', '', $this->slider->get_title())).' REVOLUTION SLIDER '. Nwdthemes_Revslider_Helper_Framework::RS_REVISION .' --><p class="rs-p-wp-fix"></p>'."\n";
		$r .= RS_T3.'<rs-module-wrap';
		$this->rs_module_wrap_open = true;
		$r .= ' id="'.$this->get_html_id().'_wrapper"';
		$r .= (!empty($class)) ? ' class="'.trim($class).'"' : '';
		if((Mage::helper('nwdrevslider/framework')->is_super_admin() || Mage::helper('nwdrevslider/framework')->is_admin_bar_showing()) && Mage::helper('nwdrevslider/framework')->current_user_can('edit_theme_options')){
			$r .= ' data-alias="'.Mage::helper('nwdrevslider/framework')->esc_attr($this->slider->get_alias()).'"';
		}
		...
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_slider_wrapper_div', $r, $this);
	}
	...
	public function close_slider_wrapper_div(){
		...
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_close_slider_wrapper_div', $r, $this);
	}
	...
	public function add_unfloat_html(){
		...
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_add_unfloat_html', $r, $this);
	}
	...
	public function get_slider_div(){
		...
		$r .= ' data-version="'. Nwdthemes_Revslider_Helper_Framework::RS_REVISION .'"';
		$r .= '>'."\n";

		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_slider_div', $r, $this);
	}
	...
	public function close_slider_div(){
		...
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_close_slider_div', $r, $this);
	}
	...
	public function get_slides(){
		...
		echo Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_slides_pre', RS_T5.'<rs-slides>'."\n", $this);
		...
		echo Mage::helper('nwdrevslider/framework')->apply_filters('revslider_get_slides_post', RS_T5.'</rs-slides>'."\n", $this);
	...
	public function get_timer_bar(){
		...
		$progress_style = ' style="height: '.Mage::helper('nwdrevslider/framework')->esc_attr($progress_height).'px; background: '.$progressbar_color.';"';
	...
	public function add_static_slide_html(){
		...
		if($this->get_do_static() && !empty($static_slide)){
			...
			if(!empty($layers)){
				...
				Mage::helper('nwdrevslider/framework')->do_action('revslider_add_static_layer_html', $this->get_slider());
	...
	public function get_image_data(){
		...
		$url_trans = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/transparent.png';
		$img	 = array('id' => false, 'src' => '', 'alt' => '', 'style' => '', 'title' => '', 'parallax' => '', 'panzoom' => '', 'width' => '', 'height' => '', 'bg' => '', 'lazyload' => '');

		if($bg_type != 'external'){
			$img['src']	= Mage::helper('nwdrevslider/images')->imageUrl($slide->image_url);
			...
			switch($slide->get_param(array('attributes', 'altOption'), $slide->get_param(array('attributes', 'titleOption'), 'media_library'))){
				case 'media_library':
					$img['alt'] = Mage::helper('nwdrevslider/framework')->get_post_meta($img['id'], '_wp_attachment_image_alt', true);
				break;
				case 'file_name':
				...
				break;
				case 'custom':
					$img['alt'] = Mage::helper('nwdrevslider/framework')->esc_attr($slide->get_param(array('attributes', 'alt'), ''));
				break;
			}

			switch($slide->get_param(array('attributes', 'titleOption'), 'media_library')){
				case 'media_library':
					$img['title'] = Mage::helper('nwdrevslider/framework')->get_the_title($img['id']);
				break;
				case 'file_name':
					$info = pathinfo($slide->image_filename);
				...
				break;
				case 'custom':
					$img['title'] = Mage::helper('nwdrevslider/framework')->esc_attr($slide->get_param(array('attributes', 'title'), ''));
				break;
			}

			if($img['id'] !== false){
				$data = Mage::helper('nwdrevslider/framework')->wp_get_attachment_metadata($img['id']);
			...
			$img['src']		= Mage::helper('nwdrevslider/framework')->esc_url($slide->get_param(array('bg', 'externalSrc'), ''));
			$img['alt']		= Mage::helper('nwdrevslider/framework')->esc_attr($slide->get_param(array('attributes', 'alt'), ''));
			$img['title']	= Mage::helper('nwdrevslider/framework')->esc_attr($slide->get_param(array('attributes', 'title'), ''));
		...
		$img['src']			 = ($this->slider->get_param(array('general', 'lazyLoad'), false) != 'none') ? Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/dummy.png' : $img['src'];
	...
	private function add_creative_layer(){
		...
		$layers = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_putCreativeLayer', $layers, $this, $this->is_static);
		$this->container_mode = '';
	...
	public function get_html_layer_type(){
		...
		return 'data-type="'.Mage::helper('nwdrevslider/framework')->esc_attr($type).'"';
	}
	...
	public function add_layer($row_group_uid = false, $special_type = false){
		$layer = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_putLayer_pre', $this->get_layer(), $this, $row_group_uid, $this->is_static, $special_type);
		$this->set_layer($layer);
		...
		echo ($special_type === false && $layertype !== 'video') ? Mage::helper('nwdrevslider/framework')->apply_filters('revslider_layer_content', stripslashes($html_layer), $html_layer, $this->slider->get_id(), $this->slide, $layer).' ' : '';
	...
	public function get_action_link(){
		...
		if(!empty($action)){
			foreach($action as $act){
				...
				$action_type = Mage::helper('nwdrevslider/framework')->apply_filters('rs_action_type', $this->get_val($act, 'action'));
				$link_type = Mage::helper('nwdrevslider/framework')->apply_filters('rs_action_link_type', $this->get_val($act, 'link_type', ''));

				if($action_type === 'link'){
					if($link_type !== 'jquery'){
						$image_link = $this->get_val($act, 'image_link', '');
						$image_link = Mage::helper('nwdrevslider/framework')->do_shortcode($image_link);
	...
	public function get_material_icons_css(){
		...
		if(Nwdthemes_Revslider_Helper_Framework::$rs_material_icons_css === false) return '';
		if(Nwdthemes_Revslider_Helper_Framework::$rs_material_icons_css_parsed === true) return '';
		...
		if(!Mage::helper('nwdrevslider/framework')->is_admin()){
			$html .= RS_T4."<script>"."\n";
			$html .= RS_T5.'var htmlDivCss = unescape("'. $css_class->compress_css(rawurlencode(Nwdthemes_Revslider_Helper_Framework::$rs_material_icons_css)) .'");'."\n";
			$html .= RS_T5."var htmlDiv = document.getElementById('rs-plugin-settings-inline-css');"."\n";
			$html .= RS_T5."if(htmlDiv) {"."\n";
			$html .= RS_T6."htmlDiv.innerHTML = htmlDiv.innerHTML + htmlDivCss;"."\n";
			$html .= RS_T5."}else{"."\n";
			...
			$me = $this->get_markup_export();
			$html .= ($me === true) ? '<!-- STYLE -->' : '';
			$html .= RS_T4 .'<style type="text/css">'. $css_class->compress_css(Nwdthemes_Revslider_Helper_Framework::$rs_material_icons_css) .'</style>';
			$html .= ($me === true) ? '<!-- /STYLE -->' : '';
		}

		Nwdthemes_Revslider_Helper_Framework::$rs_material_icons_css_parsed = true;
	...
	public function set_material_icon_css(){
		...
		foreach($layers as $layer){
			...
			if(strpos($text, 'material-icons') !== false || strpos($text_toggle, 'material-icons') !== false){
				Nwdthemes_Revslider_Helper_Framework::$rs_material_icons_css = "/*
ICON SET
*/
@font-face {
...
rs-module .material-icons {
  ...
  -moz-osx-font-smoothing: grayscale;
	...
	public function get_html_layer_action(&$html_simple_link){
		...
		if(!empty($actions)){
			foreach($actions as $num => $action){
				...
				// Filter the Actions
                $events = Mage::helper('nwdrevslider/framework')->apply_filters('rs_action_output_layer_action', $events, $action, $all_actions, $num, $this->slide);
                if(!isset($html_simple_link)){
                    $html_simple_link = '';
                }
                $html_simple_link = Mage::helper('nwdrevslider/framework')->apply_filters('rs_action_output_layer_simple_link', $html_simple_link, $action, $all_actions, $num, $this->slide, $this->slider, $events, $this);
			}
	...
	public function get_html_audio_data(){
		...
		$mp4 = Mage::helper('nwdrevslider/framework')->esc_attr($this->remove_http($this->get_val($layer, array('media', 'audioUrl'))));
		...
		if(!empty($mp4))	$data['mp4'] = Mage::helper('nwdrevslider/images')->imageUrl($mp4);
	...
	public function get_html_video_data(){
		...
		if(!empty($poster)){
			$data['poster'] = Mage::helper('nwdrevslider/images')->imageUrl($poster);
	...
	public function get_toggle_data(){
		...
		if(!in_array($this->get_val($layer, 'type', 'text'), array('shape', 'svg', 'image'), true)){
			...
			$toggle['html'] = Mage::helper('nwdrevslider/framework')->do_shortcode(stripslashes($text_toggle));
		}
	...
	public function get_html_layer(){
		...
		switch($type){
			...
			case 'button':
				...
				$html = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_modify_layer_text', $text, $layer);
			...
			case 'image':
				...
				if($lazyLoad != 'none' || $do_ll == 'force' && $do_ll !== 'ignore'){
					...
					if($seo_opti === 'false' || $seo_opti === false){
						...
						$urlImage = Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL.'public/assets/assets/dummy.png';
					}
				}
		...
		$html = (!in_array($type, array('image', 'svg', 'column', 'shape'), true)) ? Mage::helper('nwdrevslider/framework')->do_shortcode(stripslashes($html)) : $html;
		...
		switch($video_type){
			...
			case 'twitter':
				...
				if($youtube_id !== ''){
					...
					$data['mp4'] = Mage::helper('nwdrevslider/images')->imageUrl($html_mpeg);
				}
			break;
			case 'streamyoutube':
			case 'streamyoutubeboth':
			...
			case 'html5':
				...
				if(!empty($html_mpeg))	 $data['mp4'] = Mage::helper('nwdrevslider/images')->imageUrl($html_mpeg);
				if($mute_video === false) $data['video']['v'] = intval($volume);
			break;
		}
	...
	public function get_html_slide_title(){
		...
		if($this->slider->is_posts()){ //check if we are post based or normal slider
			$title = @Mage::helper('nwdrevslider/framework')->get_the_title($slide->get_id());
		}else{
			$title = $slide->get_param('title', 'Slide');
		}

		return ($title !== '') ? ' data-title="'.stripslashes(Mage::helper('nwdrevslider/framework')->esc_attr($title)).'"' : '';
	}
	...
	public function get_html_slide_description(){
		...
		if($this->slider->is_posts()){ //check if we are post based or normal slider
			$the_post = Mage::helper('nwdrevslider/framework')->get_post($slide->get_id());
			$description = strip_tags(Mage::helper('nwdrevslider/framework')->strip_shortcodes($the_post->post_excerpt));
		}else{
			$description = $slide->get_param(array('info', 'description'), '');
		}

		$description = trim(str_replace(array("\'", '\"'), array("'", '"'), Mage::helper('nwdrevslider/framework')->esc_attr($description)));
	...
	public function get_thumb_url(){
		...
		if(
			...
			if(empty($url)){ //try to get resized thumb
				$url = Mage::helper('nwdrevslider/images')->rev_aq_resize($slide->image_url, $w, $h, true, true, true);
			}else{
				$url = Mage::helper('nwdrevslider/images')->rev_aq_resize($url, $w, $h, true, true, true);
				if(empty($url)){
					$url = $slide->image_url;
					$url = Mage::helper('nwdrevslider/images')->rev_aq_resize($url, $w, $h, true, true, true);
				}
		...
		if($slide->get_param(array('seo', 'set'), false) == true){
			switch($slide->get_param(array('seo', 'type'), 'regular')){
				...
				case 'regular':
					...
					$link	= ($l !== '') ? ' data-link="'.Mage::helper('nwdrevslider/framework')->do_shortcode($l).'"'.$target : $link;
				break;
	...
	public function get_html_extra_params(){
		...
		for($mi = 0; $mi < 10; $mi++){
			...
			$mm = $mi + 1;
			$params .= ($pa !== '') ? ' data-p'.$mm.'="'.stripslashes(Mage::helper('nwdrevslider/framework')->esc_attr($pa)).'"' : '';
		}
	...
	private function modify_settings(){
		...
		$settings = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_modify_slider_settings', $settings, $this->get_slider_id());
	...
	private function modify_preview_mode_settings(){
		$js_to_body = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_modify_preview_mode_settings', false);
		...
		foreach($gf as $gfk => $gfv){
			...
			if(!empty($gfv['subsets'])){
				foreach($gfv['subsets'] as $ssk => $ssv){
					if(array_search(Mage::helper('nwdrevslider/framework')->esc_attr($gfk.'+'.$ssv), $gfsub) !== false){
						$subsets[] = $ssv;
					}
				}
			}
	...
	private function add_javascript_to_footer(){
		...
		$slver = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_remove_version', Nwdthemes_Revslider_Helper_Framework::RS_REVISION); //allows to remove slider version at the JavaScript and CSS inclusions

		$ret = RS_T3.'<script type="text/javascript" src="'.RS_PLUGIN_URL_CLEAN.'public/assets/js/revolution.tools.min.js?rev='.$slver.'"></script>'."\n";

		if(!file_exists(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/js/rs6.min.js')){
	...
	public function add_inline_double_jquery_error(){
		if(Nwdthemes_Revslider_Helper_Framework::$rs_double_jquery_script === false){
		...
		Nwdthemes_Revslider_Helper_Framework::$rs_double_jquery_script = true;
	}
	...
	public function get_html_js_start_size($optFullWidth, $optFullScreen){
		...
		if(!$this->get_markup_export()){ //not needed for html markup export
			...
			if($this->slider->get_param('layouttype') == 'fullscreen'){
				$html .= "offsetContainer:'". Mage::helper('nwdrevslider/framework')->esc_attr($this->slider->get_param(array('size', 'fullScreenOffsetContainer'), '')) ."',";
				$html .= "offset:'". Mage::helper('nwdrevslider/framework')->esc_attr($this->slider->get_param(array('size', 'fullScreenOffset'), '')) ."',";
			}
	...
	public function print_error_message($message, $open_page = false){
		...
		if(empty($html_id)){
			$html_id = 'rev_slider_error_'.Nwdthemes_Revslider_Helper_Framework::$rs_slider_serial;
		}else{
			$slides = $this->slider->get_slides();
		...
		$url = (empty($html_id) || !Mage::helper('nwdrevslider/framework')->is_user_logged_in() || $id === '') ? '' : Mage::helper('nwdrevslider/framework')->admin_url('admin.php?page=revslider&view=slide&id='.$id);
		$page_url = ($open_page === true && Mage::helper('nwdrevslider/framework')->is_user_logged_in()) ? get_edit_post_link() : '';
		...
		$html .= RS_T6.'<div class="rs_error_message_content">'.Mage::helper('nwdrevslider/framework')->esc_html($message);
		...
		if(Mage::helper('nwdrevslider/framework')->is_user_logged_in()){
			$html .=  RS_T4.'rs_eslider.style.display = "block";'."\n";
		}else{
			$html .=  RS_T4.'rs_eslider.style.display = "none";'."\n";
			$html .=  RS_T4.'console.log("'.Mage::helper('nwdrevslider/framework')->esc_html($message).'");'."\n";
		}
		$html .=  RS_T3.'</script>'."\n";
	...
	public function js_get_base_pre(){
		...
		$html .= RS_T6.'}else{'."\n";
		$html = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_fe_before_init_script', $html, $this->slider, $html_id); // needed for AddOns
	...
	public function js_get_base_post(){
		...
		ob_start();
		Mage::helper('nwdrevslider/framework')->do_action('revslider_fe_javascript_output', $this->slider, $this->get_html_id());
		$js_action = ob_get_contents();
		ob_clean();
		ob_end_clean();
	...
	public function js_get_modal() {
		...
		$c['useAsModal'] = true;
		$c['alias'] = Mage::helper('nwdrevslider/framework')->esc_attr($this->slider->get_alias());
	...
	public function js_get_root(){
		$html	= '';
		$s		= $this->slider; //shorten
		$js_loc_r = explode('://', Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL);
		$global = $this->get_global_settings();
		...
		$start_delay = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_add_js_delay', $start_delay);
		...
		*/
		...
		if($this->frontend_action){
			$keys['ajaxUrl'] = array('v' => Mage::helper('nwdrevslider/framework')->admin_url('admin-ajax.php'), 'd' => '');
			$keys['ajaxNonce'] = array('v' => Mage::helper('nwdrevslider/framework')->wp_create_nonce('RevSlider_Front'), 'd' => '');
		}
