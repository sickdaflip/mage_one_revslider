...
class RevSliderExtension {
	...
	public function init_essential_grid_extensions(){
		...
		Mage::helper('nwdrevslider/framework')->add_action('wp_footer', array($this, 'add_eg_additional_inline_javascript'));
	}
			...
			jQuery(document).ready(function() {
                ...
                ajaxRevslider = function(obj) {
					...
					var data	= {
						...
						token:			'<?php echo Mage::helper('nwdrevslider/framework')->wp_create_nonce('RevSlider_Front'); ?>',
						type:			obj.type,
						id:				obj.id,
...
$revext    = new RevSliderExtension(); // TODO: Get rid of this bad practice