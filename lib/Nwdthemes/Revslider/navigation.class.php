...
class RevSliderNavigation extends RevSliderFunctions {
	...
	public function init_by_id($nav_id){
        ...
        $row = $wpdb->get_row($wpdb->prepare("SELECT `id`, `handle`, `type`, `css`, `settings` FROM ".$wpdb->prefix.RevSliderFront::TABLE_NAVIGATIONS." WHERE `id` = %d", $nav_id), Nwdthemes_Revslider_Helper_Query::ARRAY_A);
    ...
    public function get_all_navigations_short(){
        ...
        $navigations = $wpdb->get_results("SELECT `id`, `handle`, `name` FROM ".$wpdb->prefix.RevSliderFront::TABLE_NAVIGATIONS, Nwdthemes_Revslider_Helper_Query::ARRAY_A);
    ...
    public function get_all_navigations($defaults = true, $raw = false, $old = false){
        ...
        $navigations = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix.RevSliderFront::TABLE_NAVIGATIONS, Nwdthemes_Revslider_Helper_Query::ARRAY_A);
	...
	public static function get_default_navigations(){
        ...
        include(Mage::getBaseDir('lib') . '/Nwdthemes/Revslider/navigations.php');
