...
class RevSliderCssParser extends RevSliderFunctions {
	...
	public function default_css_classes(){
		...
		return Mage::helper('nwdrevslider/framework')->apply_filters('revslider_mod_default_css_handles', $default);
	}
	...
	public function get_captions_sorted(){
		...
		$styles = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix . RevSliderFront::TABLE_CSS . " ORDER BY handle ASC", Nwdthemes_Revslider_Helper_Query::ARRAY_A);
	...
	public function get_base_css_captions(){
		include(Mage::getBaseDir('lib') . '/Nwdthemes/Revslider/basic-css.php');
	...
	public function update_static_css($css){
		...
		$c	 = Mage::helper('nwdrevslider/framework')->update_option('revslider-static-css', $css);
	...
	public function get_raw_css(){
		...
		$result = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix . RevSliderFront::TABLE_CSS, Nwdthemes_Revslider_Helper_Query::ARRAY_A);
