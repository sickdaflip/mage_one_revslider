...
class RevSliderHelp {
	public static function getIndex() {
				...
				'slider_settings' => array(
					'gst_sl_1' => array(
						...
						'shortcode' => array(
							...
							$d => __("Place the shortcode to CMS page or block where you want to show this module", 'revsliderhelp'),
							$a => $u . "module-title-shortcode/",
		...
		return array('translations' => $translations, 'helpindex' => Mage::helper('nwdrevslider/framework')->apply_filters('revslider_help_directory', $helpindex));
	}
}