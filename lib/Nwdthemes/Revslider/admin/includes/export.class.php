...
class RevSliderSliderExport extends RevSliderSlider {
	...
	public function export_slider($id = 0){
		...
		if(version_compare($this->get_param(array('settings', 'version')), Mage::helper('nwdrevslider/framework')->get_option('revslider_update_revision', '6.0.0'), '<')){
	...
	public function modify_used_data(){
		...
		$d = Mage::helper('nwdrevslider/framework')->apply_filters('revslider_exportSlider_usedMedia', $d, $this->all_slides, $this->slider_params); //$this->export_slides, $this->static_slide,
	...
	public function add_svg_to_zip(){
		if(!empty($this->used_svg)){
			$content_url	= Mage::helper('nwdrevslider/framework')->content_url();
	...
	public function add_info_to_zip(){
		if(Mage::helper('nwdrevslider/framework')->apply_filters('revslider_slider_pack_export', false)){
			if(!$this->usepcl){
