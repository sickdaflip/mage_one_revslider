...
class RevSliderSliderExportHtml extends RevSliderSliderExport {
	...
	public function replace_export_html_urls(){
		...
		$upload_dir_multi	= Mage::helper('nwdrevslider/framework')->wp_upload_dir();
		...
		if($this->export_real){ //only include if real export
			...
			if(!$this->usepcl){
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/js/rs6.min.js', 'js/rs6.min.js');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/js/revolution.tools.min.js', 'js/revolution.tools.min.js');

				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/css/rs6.css', 'css/rs6.css');

				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css', 'fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/pe-icon-7-stroke/css/helper.css', 'fonts/pe-icon-7-stroke/css/helper.css');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.eot', 'fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.eot');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.svg', 'fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.svg');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.ttf', 'fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.ttf');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.woff', 'fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.woff');

				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/font-awesome/css/font-awesome.css', 'fonts/font-awesome/css/font-awesome.css');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/font-awesome/fonts/FontAwesome.otf', 'fonts/font-awesome/fonts/FontAwesome.otf');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/font-awesome/fonts/fontawesome-webfont.eot', 'fonts/font-awesome/fonts/fontawesome-webfont.eot');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/font-awesome/fonts/fontawesome-webfont.svg', 'fonts/font-awesome/fonts/fontawesome-webfont.svg');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/font-awesome/fonts/fontawesome-webfont.ttf', 'fonts/font-awesome/fonts/fontawesome-webfont.ttf');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/font-awesome/fonts/fontawesome-webfont.woff', 'fonts/font-awesome/fonts/fontawesome-webfont.woff');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/font-awesome/fonts/fontawesome-webfont.woff2', 'fonts/font-awesome/fonts/fontawesome-webfont.woff2');

				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/revicons/revicons.eot', 'fonts/revicons/revicons.eot');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/revicons/revicons.svg', 'fonts/revicons/revicons.svg');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/revicons/revicons.ttf', 'fonts/revicons/revicons.ttf');
				$this->zip->addFile(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'/public/assets/fonts/revicons/revicons.woff', 'fonts/revicons/revicons.woff');
			}else{
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/js/rs6.min.js', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/js/', PCLZIP_OPT_ADD_PATH, 'js/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/js/revolution.tools.min.js', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/js/', PCLZIP_OPT_ADD_PATH, 'js/');

				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/css/rs6.css', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/css/', PCLZIP_OPT_ADD_PATH, 'css/');

				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/pe-icon-7-stroke/css/helper.css', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.eot', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.svg', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.ttf', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/pe-icon-7-stroke/fonts/Pe-icon-7-stroke.woff', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');

				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/font-awesome/css/font-awesome.css', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/font-awesome/fonts/FontAwesome.otf', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/font-awesome/fonts/fontawesome-webfont.eot', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/font-awesome/fonts/fontawesome-webfont.svg', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/font-awesome/fonts/fontawesome-webfont.ttf', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/font-awesome/fonts/fontawesome-webfont.woff2', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');

				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/revicons/revicons.eot', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/revicons/revicons.svg', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/revicons/revicons.ttf', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
				$this->pclzip->add(Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/fonts/revicons/revicons.woff', PCLZIP_OPT_REMOVE_PATH, Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH.'public/assets/');
			}
