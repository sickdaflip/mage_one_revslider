...
class RevSliderFavorite extends RevSliderFunctions {
	...
	public function set_favorite($do, $type, $id){
		$fav = Mage::helper('nwdrevslider/framework')->get_option('rs_favorite', array());
		$id	 = Mage::helper('nwdrevslider/framework')->esc_attr($id);
		...
		Mage::helper('nwdrevslider/framework')->update_option('rs_favorite', $fav);
